...
def fetch_pdb_content(pdb_id):
    # Get PDB content from RCSB or local file
    ...
    if not filtered_df.empty:
        ...
        if pdb_content:
            ...
            with col2:
                ...
                # Create dropdown list of epitopes for information only
                epitope_options = []
                epitope_details = {}
                ...
                # Add "View Summary" option at the beginning
                epitope_options.insert(0, "View Summary")
                
                # Dropdown selection - for information display only
                ...
                if selected_epitope == "View Summary":
                    # Show summary of all epitopes
                    st.markdown(f"**Total epitopes:** {len(filtered_df)}")
                else:
                    # Show details for selected epitope (informational only)
